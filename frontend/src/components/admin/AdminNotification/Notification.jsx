...
const AdminNotification = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-4 sm:p-6 lg:p-8 w-full">
      <div className="w-full">
        ...
        {/* Search and Filters */}
        <div className="bg-white rounded-2xl border border-slate-200 p-4 mb-6 shadow-sm w-full">
...
const NotificationCard = ({ notification, onMarkRead, onDelete, onClick }) => {
  const typeConfig =
    NOTIFICATION_TYPES[notification.type] || NOTIFICATION_TYPES.system_alert;
  const Icon = typeConfig.icon;

  return (
    <div
      className={`group rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition-all hover:shadow-md hover:-translate-y-0.5 cursor-pointer ${
        notification.isUnread ? "ring-1 ring-blue-200" : ""
      }`}
      onClick={onClick}
    >
