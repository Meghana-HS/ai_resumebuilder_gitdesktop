...
const CoverLetterPreview = forwardRef(
  (
    ...
    // Word standard: 1 in top/bottom (96 px), 1.25 in left/right (120 px) at 96 DPI
    const CoverContent = () => {
      return (
        <div
          style={{
          ...
          >
            ...
            {companyAddress &&
              companyAddress
                .split("\n")
                .filter(Boolean)
                .map((line, i) => <div key={`caddr-${i}`}>{line}</div>)}
          </div>
    ...
    const Toolbar = () => (
      ...
      >
        ...
        >
          ...
          <Badge green={isUserData}>
            {isUserData ? "Your data" : "Sample"}
          </Badge>
